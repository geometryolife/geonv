...
function M.config()
    ...
    G.map({
        ...
        { 'n', '<Space>k', ':call CocAction("doHover")<CR>', { silent = true } },
        ...
        { 'n', '<Space>c', "get(b:, 'coc_git_blame', '') ==# 'Not committed yet' ? \"<Plug>(coc-git-chunkinfo)\" : \"<Plug>(coc-git-commit)\"", { silent = true, expr = true } },
